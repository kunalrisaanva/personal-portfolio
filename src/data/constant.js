...
export const experiences = [
    {
      ...
      desc: "Working on the Blogee platform — developed and maintained robust APIs using Node.js, improving backend functionality and performance. Built scalable microservices, handled aggregation pipelines, integrated Firebase services, and deployed on AWS EC2.",
      skills: [
        "AWS",
        "EC2",
        "JavaScript",
...
export const education = [
  {
    ...
    school: "M.N.S Govt. College, Bhiwani",
    date: "Oct 2021 - Sep 2024",
    grade: "8.71 CGPA",
    desc: "I have recently completed a Bachelor's degree from M.N.S Govt. College, Bhiwani. I have completed 6 semesters and have a CGPA of 8.71. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among others. I am also doing freelancing work, where I am learning and working on exciting projects with a team of talented developers.",
  ...
  },
  {
    ...
    school: "Adarsh Sr. Sec. School, Bound",
...
export const projects = [
  {
    ...
    category: "full stack",
    github: "https://github.com/kunalrisaanva",
    webapp: "https://clikkme.in/",
  },

  {
    id: 1,
    title: "Blogee - Blogging Platform",
...

  {
    ...
    category: "full stack",
    github: "https://github.com/kunalrisaanva",
    webapp: "https://staging.skillbridge.net/",
  },

  {
    ...
    tags: ["TypeScript", "Next Js", "Aceternity Ui", "Tailwind CSS"],
...

  {
    ...
    description:
      "I created a page in React Js. This is a single page but with a clean UI for Nike shoes. I used Tailwind CSS for styling and also used react icons for icons.",
    image:
...

  {
    ...
    description:
      "A clone with the same functionality as the real one, where users can see other posts, upload their own, and delete posts.",
    image:
...

  {
    ...
    description:
      "Built a chat application using Node JS and EJS with the help of Socket.io. We can chat in real time. Also has the feature to edit and delete chats.",
    image:
